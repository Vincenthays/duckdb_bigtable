...
test_where_pushdown: debug
    ./build/debug/duckdb --init '' -c "SELECT pe_id, price FROM product(2024_20, 2024_20, [1124000100000]) WHERE pe_id IN (1124000100000, 1124000100012, 1124000100006, 1124000100005)"
